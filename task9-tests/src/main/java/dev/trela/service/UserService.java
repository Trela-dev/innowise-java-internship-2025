...
import dev.trela.exception.DefaultRoleNotFoundException;
...
public class UserService {
    ...
    public void registerUser(String username,String password){
        ...
        try {
            ...
            throw new UsernameAlreadyInUseException(messageService.getMessage("user.username.duplicate",username));
        }
