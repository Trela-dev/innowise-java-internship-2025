...
@TestPropertySource(properties = "jwt.expiration.time-minutes=1")
public class AuthControllerIT{
    ...
    void shouldRegisterUserSuccessfully(){
        User user = new User("john_doe", "password123", null, "test@gmail.com");
    ...
    void shouldFailWhenUsernameIsEmpty(){
        User user = new User("", "password123",null, "test@gmail.com");
